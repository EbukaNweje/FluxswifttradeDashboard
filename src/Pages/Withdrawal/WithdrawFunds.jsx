...
const WithdrawFunds = () => {
    ...
    const url = `https://fluxswifttradebackend.onrender.com/api/requestwithdrawcode/${id}`
    const urlll = `https://fluxswifttradebackend.onrender.com/api/withdraw/${id}`
    const urlprofit = `https://fluxswifttradebackend.onrender.com/api/transferprofittoaccount/${id}`
    const urlemail = `https://fluxswifttradebackend.onrender.com/api/withdrawalemailsend/${id}`
